...
setJSON(JSON.stringify({taskList:o}),function(e,t,s){loadTasks()})})}function getJSON(e){$.get(jsonUrl,e)}function setJSON(e,t){$.ajax({url:jsonUrl,type:"PUT",data:e,contentType:"application/json; charset=utf-8",dataType:"json",success:t})}function getTimeString(e){var t=Math.floor(e/ONE_HOUR)%24,s=Math.floor(e/ONE_DAY)%7,n=Math.floor(e/ONE_WEEK),o=""
return n>0&&(o+=n+"w "),s>0&&(o+=s+"d "),t>0&&(o+=t+"h"),o.trim().replace(/ /g,"<br>")}function sortFunction(e,t){return e.subject<t.subject?-1:e.subject>t.subject?1:0==e.due?1:0==t.due?-1:e.due>t.due?1:e.due<t.due?-1:0}function oddOrEven(e){return e%2==0?"odd":"even"}function keyPressed(e){e||(e=window.event)
